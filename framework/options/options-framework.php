...
define('OPTIONS_FRAMEWORK_URL', get_bloginfo('template_url') . '/framework/options/');
...
function optionsframework_add_page() {
	...
	$of_page = add_submenu_page('themes.php', 'Framework Options', 'Framework Options', 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_page() {
	...
	<h2><?php esc_html_e( 'Framework Options' ); ?></h2>
